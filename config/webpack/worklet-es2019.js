...
module.exports = {
    entry: {
        worklet: './node_modules/limiter-audio-worklet-processor/build/es2019/module.js'
    },
    mode: 'production',
    module: {
        rules: [
                            ...
                            for (const chunk of compilation.chunks) {
                                for (const file of chunk.files) {
                                    compilation.updateAsset(file, (asset) => {
                                        ...
                                        return new RawSource(`// This is the minified and stringified code of the limiter-audio-worklet-processor package.
